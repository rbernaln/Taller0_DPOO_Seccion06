...
public class ConsolaOlimpicos
{
	...
	private void ejecutarAtletaPais() {
		...
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		String pais=calculadora.atletaPorPais(nombre_atleta);
		if (pais.length()!=0) {
			System.out.println("El atleta "+nombre_atleta+" pertenece al país "+pais);
		}else {
			System.out.println("No se encontró al atleta "+nombre_atleta+".");
		}
